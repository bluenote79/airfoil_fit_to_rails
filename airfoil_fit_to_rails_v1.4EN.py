...
COMMAND_ID = "Airfoil"
B1_BUTTON_ID = "DAT file"
B1_BUTTON_NAME = "DAT file"
SE01_SELECTION_INPUT_ID = "rail at leading edge"
SE02_SELECTION_INPUT_ID = "rail at trailing edge"
SE04_SELECTION_INPUT_ID = "plane"
I0_VALUE_ID = "trailing edge thickness"
I0_VALUE_NAME = "trailing edge thickness"
...
C1_CHECKBOX_ID = "break airfoil at the leading edge"
C2_CHECKBOX_ID = "vertical tangent handle"
I1_VALUE_ID = "thickness factor"
I1_VALUE_NAME = "thickness factor"
T00_TEXTBOX_ID = "DAt file not imported"
T01_TEXTBOX_ID = "file successfully imported"
        ...
        try:
            ...
            try:
                ...
                if inputs.itemById(SE02_SELECTION_INPUT_ID).selection(0).isValid == True:
                    pass
                if filename == "":
                    assert filename != 0, ui.messageBox("Keine Dat-Datei geladen!")
            ...
            try:
                assert filename !="", "Es wurde keine DAT-Datei ausgewählt!"
            except:
                ui.messageBox("Es wurde keine DAT-Datei ausgewählt!")
...
class FoilCommandCreatedHandler(adsk.core.CommandCreatedEventHandler):
    ...
    def notify(self, args: adsk.core.CommandEventArgs):
        try:
            ...
            groupCmdInput0 = tab1ChildInputs.addGroupCommandInput("group0", "DAT file import:")
            ...
            groupCmdInput1 = tab1ChildInputs.addGroupCommandInput(
                "group1", "Selection of rails and plane:"
            )
            ...
            groupCmdInput3 = tab1ChildInputs.addGroupCommandInput("group3", "leading edge:")
            ...
            groupCmdInput4 = tab1ChildInputs.addGroupCommandInput("group4", "trailing edge:")
            ...
            groupCmdInput5 = tab1ChildInputs.addGroupCommandInput("group5", "airfoil thickness:")
            ...
            inst_text1 = """ <p><strong>Instructions:</strong></p> \
                <p>First import DAT file. \
                Select rails for leading edge and trailing edge.\
...
class AirfoilData:
    ...
    def __init__(self, filename, name, profile, aufdickung):
        self.aufdickung = aufdickung
        self.filename = filename
        self.name = name
